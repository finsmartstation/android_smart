...
public class FrameLayoutAudio extends FrameLayout {
    private final ArrayList<View> mMatchParentChildren = new ArrayList<View>(1);

    public FrameLayoutAudio(Context context) {
        super(context);
    }

    public FrameLayoutAudio(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FrameLayoutAudio(Context context, AttributeSet attrs, int defStyle) {
