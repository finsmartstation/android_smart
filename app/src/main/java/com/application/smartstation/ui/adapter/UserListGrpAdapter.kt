...
class UserListGrpAdapter(val context: Context) : RecyclerView.Adapter<UserListGrpAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_user_list_grp, parent, false)
