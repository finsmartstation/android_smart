...
import com.application.smartstation.databinding.ItemChatHisGrpBinding
...
class AdapterChatGrp(val context: Context) : RecyclerView.Adapter<AdapterChatGrp.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_chat_his_grp, parent, false)
        ...
        with(holder) {
            if (model.type.equals("date")) {
                ...
                if (model.type.equals("receive")){
                    ...
                    binding.icReceiver.txtName.text = model.name
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val binding = ItemChatHisGrpBinding.bind(itemView)
    }
