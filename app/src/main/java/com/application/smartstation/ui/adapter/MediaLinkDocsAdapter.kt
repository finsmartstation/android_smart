...
class MediaLinkDocsAdapter(val context: Context) : RecyclerView.Adapter<MediaLinkDocsAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_media_link_docs, parent, false)
