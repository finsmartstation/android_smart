...
class SecurityActivity : BaseActivity() {
    ...
    private fun initView() {
        ...
        if (biometricManager.canAuthenticate() == BiometricManager.BIOMETRIC_ERROR_NO_HARDWARE) {
            ...
            binding.llFingerPrint.visibility = View.GONE
            binding.scFingerprint.isChecked =
                UtilsDefault.getSharedPreferenceString(Constants.FINGERPRINT) != null && UtilsDefault.getSharedPreferenceString(
                    Constants.FINGERPRINT) == "yes"
        }
    ...
    override fun onResume() {
        super.onResume()
        binding.scPasscode.isChecked =
            UtilsDefault.getSharedPreferenceString(Constants.PASSCODE) != null && UtilsDefault.getSharedPreferenceString(
