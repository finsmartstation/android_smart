...
import com.application.smartstation.ui.model.MailAttachmentList
...
class MailAttachAdapter(val context: Context) : RecyclerView.Adapter<MailAttachAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        with(holder) {
            ...
            if (isImageFile(model)){
                ...
                Glide.with(context).load(model).placeholder(R.drawable.ic_default).error(R.drawable.ic_default).diskCacheStrategy(DiskCacheStrategy.DATA).into(binding.imgPath)
