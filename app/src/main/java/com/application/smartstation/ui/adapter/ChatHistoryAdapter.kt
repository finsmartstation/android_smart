...
class ChatHistoryAdapter(val context: Context) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.item_chat_his, parent, false)
...
//                        }
                        ...
                        binding.txtTimeSend.text =
                            UtilsDefault.todayDate(UtilsDefault.localTimeConvert(model.date))
                        binding.txtTimeImgSend.text =
                            UtilsDefault.todayDate(UtilsDefault.localTimeConvert(model.date))
                    } else {
