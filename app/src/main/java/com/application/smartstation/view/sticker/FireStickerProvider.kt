package com.application.smartstation.view.sticker
    ...
    override fun getLoader(): StickerLoader {
        return object : StickerLoader {
            ...
            override fun onLoadStickerCategory(view: View, stickerCategory: StickerCategory<*>, selected: Boolean) {
                try {
                    Glide.with(view).load(stickerCategory.categoryData.toString().toInt()).apply(
                        RequestOptions.fitCenterTransform()).into((view as AppCompatImageView))
